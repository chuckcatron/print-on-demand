...
let OrdersController = class OrdersController {
    constructor(ordersService, loggerService) {
    ...
    createOrder(orderData, req) {
        this.loggerService.log(`Creating order for product ${orderData.product.id ?? 123} by user ${req.user.userId}`);
        try {
